angular.module('tanfolyamApp').controller('registrationController', RegistrationController);

RegistrationController.$inject = ['$filter', 'registrationRS', 'userRS', '$stateParams', '$translate', '$scope'];

function RegistrationController($filter, registrationRS, userRS, $stateParams, $translate, $scope) {
  var vm = this;
